        ...
        <>
            ...
            <div class="container-lg">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-5 d-none d-md-block" style={{ color: 'red', marginLeft: '100px' }} >
                        <h1>We can take you anywhere</h1>
                        <p class="lead text-muted">Explore the Kameroon with Kmer</p>
                        <svg width="100%" height="60vh" viewBox="0 0 15 15" version="1.1" id="bus" xmlns="http://www.w3.org/2000/svg">
